...
function LivePlants() {
  ...
  const storedBuy = localStorage.getItem("buyLivePlant") || [];
  const collectionName = "livePlants";
  ...
  useEffect(() => {
    localStorage.setItem("buyLivePlant", JSON.stringify(buy));
  }, [buy]);
  ...
  return (
    <div className=" w-full grid sm:grid-cols-2  grid-cols-1 ">
      ...
      <div className=" w-full  ">
        <img  className=" w-full  " src="/images/card item (1).png" alt="" />
      </div>
      {/* div2 */}
      <div className=" w-full bg-Gray grid sm:grid-cols-2 grid-rows-1 grid-cols-1 ">
          ...
          {flowers.map((flower,index) => (
            <div style={{
            ...
            }} className= "md:h-[250px] text-white font-bold  flex flex-col justify-center items-center sm:h-[200px] h-[350px]">
              ...
              <div className=" flex items-center justify-center ">
                ...
                className="p-2  cursor-pointer bg-white text-black rounded align-middle mr-2">+</span>
                <span className="p-2  bg-white text-black rounded align-middle mr-2"> {flower.quantity}</span>
                <span 
                onClick={() => decrementQuantity(index)}
                className="p-2 cursor-pointer bg-white text-black rounded align-middle">-</span>
              </div>
